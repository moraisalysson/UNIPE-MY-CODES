...
public class UsaAcademia {
	...
	public static void main(String[] args) {
		...
		p = new Aluno();
		/**
		 * Exemplo de POLIMORFISMO, pois uma PESSOA se transforma em ALUNO, porém, a referência ainda é para uma PESSOA
		 */
		
		((Aluno)p).getMatricula(); 
		/**
		 * Fazendo um casting (conversão). Convertendo PESSOA para ALUNO
		 */
