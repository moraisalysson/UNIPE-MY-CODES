...
public class VendaMain {
	...
	public static void main(String[] args) {
		...
		Vendedor vendendor01 = new Vendedor("Alysson", "Rua Tal", "001");
		Venda venda01 = new Venda();
		
		Produto produto_com_desconto = new Produto("002", "Monitor", 100.00, 80.00, true);
		Vendedor vendendor02 = new Vendedor("Morais", "Rua Tal 2", "001");
		Venda venda02 = new Venda();

		Venda venda03 = new Venda();
		
		venda01.setVendedor(vendendor01);
		venda01.setProduto(produto_sem_desconto);
		venda01.setQuantidadeItens(2);
		System.out.printf("Comissão do vendendor: %.2f %% %n%n", vendendor01.getComissao() * 100);
		venda01.imprimir();
		
		venda02.setVendedor(vendendor02);
		venda02.setProduto(produto_com_desconto);
		venda02.setQuantidadeItens(3);
		venda02.setDesconto(0.10);
		System.out.printf("Comissão do vendendor: %.2f %% %n", vendendor02.getComissao() * 100);
		venda02.imprimir();
		
		venda03.setVendedor(vendendor02);
